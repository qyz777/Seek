...
- (void)initView {
    ...
    //题目标题
    UIView *questionView = [[UIView alloc] initWithFrame:CGRectMake(kInterval, closeBtn.bottom + kInterval + 150, SCREEN_WIDTH - 2 * kInterval, 40)];
...
// 头像区
- (void)getHeaderViewWithImg:(NSString *)imgName andName:(NSString *)name {
